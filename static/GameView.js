        ...
        */
        ...
        processEvent: function(event) {
            ...
            if(event.type == 'draw card') {
                ...
                /*
                This function generates a test card with some test characteristics. See ClientCard.js for more
                information on the characteristics of the card, and IDToImage for the image generated by the card.
                */
                let card = ClientCard.test();

                card.sprite.width = displayElements.app.stage.width * .086;
                card.sprite.height = displayElements.app.stage.height * .225;
